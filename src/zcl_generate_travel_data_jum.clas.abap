CLASS zcl_generate_travel_data_jum DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_jum IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_jum.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_jum.

*   insert the new table entries
    INSERT ztravel_jum FROM TABLE @itab.
